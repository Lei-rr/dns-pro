...
import { providerPath, providerTypeLabel } from '@/features/providers/lib/paths'
import { providerAvatarColor } from '@/features/providers/lib/branding'
  ...
  <div class="flex flex-1 flex-col gap-5">
    ...
    <div v-if="providers.length || providerStore.loading" class="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
      ...
      >
        ...
        <ArrowRight class="text-muted-foreground size-4 shrink-0 opacity-60 transition-transform group-hover:translate-x-0.5" />
      </RouterLink>
    </div>
  </div>
</template>
